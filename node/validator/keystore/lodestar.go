...
func (ks *LodestarKeystoreManager) GetAllPubkeys() ([]beacon.ValidatorPubkey, error) {
...
func (ks *LodestarKeystoreManager) EncryptValidatorKey(key *eth2types.BLSPrivateKey, derivationPath string, password string) (beacon.ValidatorKeystore, error) {
...
func (ks *LodestarKeystoreManager) StoreValidatorKeystore(keystore beacon.ValidatorKeystore, password string) error {
	// Encode key store
...
func (ks *LodestarKeystoreManager) RemoveValidatorKey(pubkey beacon.ValidatorPubkey) error {
	// Get key file path
	keyFilePath := ks.getKeystoreFilePath(pubkey)
...
func (ks *LodestarKeystoreManager) getKeystoreFilePath(pubkey beacon.ValidatorPubkey) string {
...
func (ks *LodestarKeystoreManager) getSecretFilePath(pubkey beacon.ValidatorPubkey) string {
