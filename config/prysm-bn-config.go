...
const (
	// Tags
	prysmBnProdTag string = "gcr.io/offchainlabs/prysm/beacon-chain:v7.0.0" // "nodeset/prysm:v6.0.3"
	prysmBnTestTag string = "gcr.io/offchainlabs/prysm/beacon-chain:v7.0.0"
)
